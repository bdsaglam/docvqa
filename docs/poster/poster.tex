...
contribute nothing. Perception is the \keyval{binding constraint} --- no model
...
\begin{panel}{THE CONSTRAINT AND THE LEVER}
...
\vspace{5pt}
{\centering\includegraphics[width=0.88\linewidth]{figures/f5-matrix-poster.png}\par}
\figcap{\textbf{Fig.~3.} Reasoner $\times$ VLM matrix (val ANLS). Across a row
(better eyes) +7--9~pts; down a column (better reasoner) +21.
\keyval{The strong-director corner wins}: 27B reasoner with 4B eyes (32.8)
beats the reverse (21.1).}
