...
DocVQA asks a model to answer questions over documents from a one-page
infographic to a 280-page report. General VLMs read every page at fixed resolution and miss fine detail on
...
\begin{panel}{THE TASK, AND WHY IT'S HARD}
...
+15~pts over ReAct) but cannot rescue one too weak to code (4B Gemma collapses).
\end{panel}
