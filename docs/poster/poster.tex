...
REPL and the perception call; generality and trajectory format contribute
nothing, and added OCR even costs accuracy. Perception is the \keyval{binding constraint} --- no model
...
low-20s. \keyval{Enrichments don't help:} a general sub-agent (36.7\%) and
append-only vs.\ compacted trajectory (39.5\% vs.\ 41.9\%) are within noise;
OCR + search on top \keyval{costs accuracy} (36.6\%): misparsed pages arrive as
confident text and crowd out the verifying look.
