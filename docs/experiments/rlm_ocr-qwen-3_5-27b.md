...
n=6 so far (target n=8): 12.50 / 13.75 / 13.75 / 15.00 / 13.75 / 15.00 → running mean
**13.96% ± 0.94pp** — extremely tight. The OCR-text-only control lands
...
are 0/10 in all six trials** (OCR captures none of the figure/drawing
