...
| t8 | `raw-vlm-multi-cmp-val-t8` | 22.50% | 18/80 | — | business_report 0/10, comics 0/10 (eighth time) |
...
2/10, infographics 3/10, maps 1/10, science_paper 3/10, science_poster
3/10, slide 3/10.
...
**n=8 COMPLETE: 20.47% ± 1.63pp** (18.75 / 22.50 / 21.25 / 18.75 / 21.25 / 18.75 / 20.00 / 22.50). vs `rvlm` (39.38% ± 1.49pp): **Δ +18.91pp** scaffold lift.
business_report and comics are **0/10 in all eight trials** — a single
