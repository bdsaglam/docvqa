...
| t8 | `direct-vlm-cmp-val-t8` | 23.75% | 19/80 | — | science_poster/slide 4/10; **died+resumed ~7×** — comics_3/comics_4 crash the long-image display, only cleared stochastically |
...
**n=8 COMPLETE: 22.34% ± 2.79pp** (21.25 / 21.25 / 18.75 / 26.25 / 21.25 / 26.25 / 20.00 / 23.75).
≈ `raw_vlm_multi` (20.47%) — putting raw pixels in the agent's own
context buys no more than a single multi-image read. vs `rvlm` (39.38%):
**Δ +17.04pp**. **Operational note:** by far the slowest
