...
| t8 | `official-cmp-val-t8` | 17.50% | 14/80 | — | business_report/comics/maps 0/10, infographics 5/10 |
...
Per-category (t4): business_report 0/10, comics 0/10, engineering_drawing
2/10, infographics 6/10, maps 1/10, science_paper 2/10, science_poster
1/10, slide 2/10.
...
n=8 COMPLETE: 15.00 / 18.75 / 18.75 / 17.50 / 21.25 / 16.25 / 17.50 / 17.50 → running mean **17.81% ± 1.86pp**, below our parity-prompt `raw_vlm_multi_baseline` (20.83%, n=3), so the minimized prompt is NOT crippling the baseline (if anything the official prompt + max_pages=10 downscale is weaker). Mean ± std at n=8.
