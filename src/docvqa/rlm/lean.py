"""Lean RLM — slimmed-down variant for solvers with detailed task instructions.

Reduces the ACTION_INSTRUCTIONS_TEMPLATE to minimal REPL mechanics,
avoiding redundancy with solver-specific prompts (approach, exploration,
iteration strategy). Based on rlm.py.
"""
